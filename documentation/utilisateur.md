...
Notre site vous permet d'estimer votre production de CO2 en fonction de vos habitudes alimentaires, de votre lieu de résidence, de vos moyens de transport ou encore de vos appareils numériques.
...
- Estimez votre empreinte carbone annuel en remplissant un formulaire.

### Visualiser les résultats
- Consulter votre production de CO2 sous forme de graphe dans votre profil.
- Consulter les détails de votre production pour savoir où faire des efforts.

### Suivi des données
- Si vous avez un compte, vous pouvez consulter vos anciennes données et constater votre évolution
